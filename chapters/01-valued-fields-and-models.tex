...
\section{Permament Models}\label{sec:permament-models}
...
\begin{proof}
    ...
    equivalent to (\ref{lem:conditions-for-normality-i}).
...
\begin{example}
    \begin{enumerate}
        \item Consider a pre-model with special fibre $\X_s \coloneqq \Spec{k[x,y]/(x^2,xy)}$, which is topologically equivalent
            to $\AA^1(k)$.
...
\begin{proposition}[{\cite[Corollary 2.2 (ii)]{ArzdorfWewers}}]
